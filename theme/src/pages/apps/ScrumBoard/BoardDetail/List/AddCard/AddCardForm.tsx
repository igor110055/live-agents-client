          ...
          >
            <Grid item xs={12} md={6}>
              <Autocomplete
                multiple
                id="tags-outlined"
                options={labelList as LabelObj[]}
                getOptionLabel={(option:LabelObj) => option.name}
                value={selectedLabels}
                onChange={(event, value) => setSelectedLabels(value as LabelObj[])}
            ...
            <Grid item xs={12} md={6}>
              <Autocomplete
                multiple
                id="tags-outlined"
                options={memberList as MemberObj[]}
                getOptionLabel={(option:MemberObj) => option.name}
                value={selectedMembers}
                onChange={(event, value) => setMembersList(value as MemberObj[])}
